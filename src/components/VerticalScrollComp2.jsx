...
const VerticalScrollComp2 = () => {
  return (
    <div className="relative ">
      <div className="absolute max-w-[1200px] md:left-[-210%] mdh:left-[-185%] mdh:top-[436px] xl:left-[-135%] sm:left-[-220%] smg:left-[-165%]  mx-auto sm:top-[462px] smg:top-[436px] lg:top-[262.249px] transform rotate-90 left-[-135%] xxl:left-[-125%] h-[-2330px] w-[165.5vw] xl:top-[242px]">
...
export default VerticalScrollComp2;
